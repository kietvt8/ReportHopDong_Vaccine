...
public class rptHopDong_VaccineV2_MCredit : XtraReport, IReport
{
	...
	public rptHopDong_VaccineV2_MCredit()
	{
		InitializeComponent();
	}
	...
	{
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(rptHopDong_VaccineV2_MCredit));
		...
		xrLabel137 = new XRLabel();
		xrLabel136 = new XRLabel();
		xrLabel131 = new XRLabel();
		xrLabel39 = new XRLabel();
		xrCheckBox2 = new XRCheckBox();
		...
		xrLabel25.LocationFloat = new PointFloat(0f, 100.2499f);
		xrLabel25.Name = "xrLabel25";
		xrLabel25.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel25.SizeF = new SizeF(748.8231f, 25.00001f);
		...
		xrLabel24.LocationFloat = new PointFloat(0.6249745f, 75.24992f);
		xrLabel24.Name = "xrLabel24";
		xrLabel24.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel24.SizeF = new SizeF(748.1981f, 25f);
		...
		xrLabel23.LocationFloat = new PointFloat(0f, 50.24993f);
		xrLabel23.Name = "xrLabel23";
		xrLabel23.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel23.SizeF = new SizeF(748.9064f, 25f);
		...
		xrLabel21.LocationFloat = new PointFloat(0f, 25.24993f);
		xrLabel21.Name = "xrLabel21";
		xrLabel21.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel21.SizeF = new SizeF(749.0834f, 25f);
		...
		PanelDetail.Controls.AddRange(new XRControl[116]
		{
			xrLabel40, xrLabel137, xrLabel136, xrLabel131, xrLabel39, xrCheckBox2, xrCheckBox1, xrLabel41, xrLabel133, xrLabel132,
			xrLabel129, xrLabel128, xrLabel127, xrLabel126, xrLabel125, xrLabel124, xrLabel123, xrLabel122, xrLabel121, xrLabel120,
			xrLabel119, xrLabel118, xrLabel117, xrLabel116, xrLabel115, xrLabel114, xrLabel113, xrLabel112, xrLabel111, xrLabel109,
			xrLabel108, xrLabel107, xrLabel106, xrLabel105, xrLabel104, xrLabel103, xrLabel102, xrLabel101, xrLabel100, xrLabel99,
			xrLabel98, xrLabel97, xrLabel96, xrLabel95, xrLabel94, xrLabel93, xrLabel92, xrLabel91, xrLabel90, xrLabel69,
			xrLabel66, xrLabel65, xrLabel64, xrLabel63, xrLabel62, xrLabel57, xrLabel55, xrLabel54, xrLabel38, xrLabel35,
			xrLabel53, xrLabel52, xrLabel51, xrLabel50, xrLabel48, xrLabel47, xrLabel46, xrLabel45, xrLabel44, xrLabel43,
			xrLabel37, xrLabel36, xrLabel33, xrLabel32, xrLabel31, xrLabel30, xrLabel29, xrLabel28, xrLabel56, xrLabel34,
			xrLabel87, xrLabel71, xrLabel70, xrLabel14, xrLabel13, xrLabel12, xrLabel11, xrLabel10, xrLabel9, xrLabel72,
			xrLabel15, xrLabel6, xrLabel8, xrLabel79, xrLabel7, xrLabel110, xrLabel73, xrLabel78, xrLabel27, xrLabel26,
			xrLabel83, xrLabel82, xrLabel81, xrLabel5, xrLabel17, xrLabel77, xrLabel85, xrLabel20, xrLabel18, xrLabel19,
			xrLabel84, xrLabel22, xrLabel16, xrLabel135, xrLabel134, xrLabel42
		});
		PanelDetail.KeepTogether = false;
		PanelDetail.LocationFloat = new PointFloat(0f, 125.25f);
		PanelDetail.Name = "PanelDetail";
		PanelDetail.SizeF = new SizeF(750f, 1773.068f);
		PanelDetail.StylePriority.UseBorders = false;
		PanelDetail.BeforePrint += PanelDetail_BeforePrint;
		xrLabel40.Font = new Font("Times New Roman", 12f, FontStyle.Bold);
		xrLabel40.LocationFloat = new PointFloat(324.9164f, 337.8125f);
		xrLabel40.Name = "xrLabel40";
		xrLabel40.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel40.SizeF = new SizeF(70.13855f, 21f);
		xrLabel40.StylePriority.UseFont = false;
		xrLabel40.Text = "Phụ lục I";
		xrLabel137.Font = new Font("Times New Roman", 12f);
		xrLabel137.LocationFloat = new PointFloat(100.7278f, 712.2729f);
		xrLabel137.Name = "xrLabel137";
		xrLabel137.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel137.SizeF = new SizeF(647.2614f, 117.8186f);
		xrLabel137.StylePriority.UseFont = false;
		xrLabel137.StylePriority.UseTextAlignment = false;
		xrLabel137.Text = componentResourceManager.GetString("xrLabel137.Text");
		xrLabel137.TextAlignment = TextAlignment.TopJustify;
		xrLabel136.Font = new Font("Times New Roman", 12f);
		xrLabel136.LocationFloat = new PointFloat(73.73914f, 712.2728f);
		xrLabel136.Name = "xrLabel136";
		xrLabel136.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel136.SizeF = new SizeF(26.52272f, 20.82404f);
		xrLabel136.StylePriority.UseFont = false;
		xrLabel136.StylePriority.UseTextAlignment = false;
		xrLabel136.Text = "-";
		xrLabel136.TextAlignment = TextAlignment.TopJustify;
		xrLabel131.Font = new Font("Times New Roman", 12f);
		xrLabel131.LocationFloat = new PointFloat(73.73914f, 691.4488f);
		xrLabel131.Name = "xrLabel131";
		xrLabel131.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel131.SizeF = new SizeF(26.52272f, 20.82404f);
		xrLabel131.StylePriority.UseFont = false;
		xrLabel131.StylePriority.UseTextAlignment = false;
		xrLabel131.Text = "-";
		xrLabel131.TextAlignment = TextAlignment.TopJustify;
		xrLabel39.Font = new Font("Times New Roman", 12f, FontStyle.Regular, GraphicsUnit.Point, 0);
		xrLabel39.LocationFloat = new PointFloat(73.73914f, 614.0887f);
		xrLabel39.Name = "xrLabel39";
		xrLabel39.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel39.SizeF = new SizeF(674.2505f, 77.36023f);
		xrLabel39.StylePriority.UseFont = false;
		xrLabel39.StylePriority.UseTextAlignment = false;
		xrLabel39.Text = componentResourceManager.GetString("xrLabel39.Text");
		xrLabel39.TextAlignment = TextAlignment.TopJustify;
		xrCheckBox2.LocationFloat = new PointFloat(52.08332f, 614.0887f);
		xrCheckBox2.Name = "xrCheckBox2";
		xrCheckBox2.SizeF = new SizeF(13.54743f, 14.66669f);
		xrCheckBox2.StylePriority.UseTextAlignment = false;
		xrCheckBox2.TextAlignment = TextAlignment.MiddleCenter;
		xrCheckBox2.WordWrap = false;
		xrCheckBox1.LocationFloat = new PointFloat(52.10546f, 487.9064f);
		xrCheckBox1.Name = "xrCheckBox1";
		xrCheckBox1.SizeF = new SizeF(13.54743f, 14.66669f);
		xrCheckBox1.StylePriority.UseTextAlignment = false;
		xrCheckBox1.TextAlignment = TextAlignment.MiddleCenter;
		xrCheckBox1.WordWrap = false;
		xrLabel41.Font = new Font("Times New Roman", 12f, FontStyle.Bold);
		xrLabel41.LocationFloat = new PointFloat(51.68776f, 379.8551f);
		xrLabel41.Name = "xrLabel41";
		xrLabel41.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel41.SizeF = new SizeF(63.39677f, 20.99997f);
		xrLabel41.StylePriority.UseFont = false;
		xrLabel41.Text = "Đặt cọc:";
		...
		xrLabel133.SizeF = new SizeF(305.6852f, 21f);
		xrLabel133.StylePriority.UseFont = false;
		xrLabel133.Text = "đính kèm Xác nhận này (\"                 \").";
		xrLabel132.Font = new Font("Times New Roman", 12f, FontStyle.Bold);
		xrLabel132.LocationFloat = new PointFloat(190.5511f, 1569.252f);
		...
		xrLabel129.LocationFloat = new PointFloat(52.08332f, 463.0886f);
		xrLabel129.Name = "xrLabel129";
		xrLabel129.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel129.SizeF = new SizeF(92.69643f, 21.78f);
		xrLabel129.StylePriority.UseFont = false;
		xrLabel129.Text = "Thanh toán:";
		...
		xrLabel127.LocationFloat = new PointFloat(25.34421f, 1712.686f);
		...
		xrLabel126.LocationFloat = new PointFloat(0f, 1712.686f);
		...
		xrLabel125.LocationFloat = new PointFloat(1.363548f, 1635.252f);
		...
		xrLabel124.LocationFloat = new PointFloat(27.23878f, 1635.254f);
		...
		xrLabel123.LocationFloat = new PointFloat(52.68647f, 1613.252f);
		...
		xrLabel122.LocationFloat = new PointFloat(25.70782f, 1613.252f);
		...
		xrLabel121.LocationFloat = new PointFloat(25.70782f, 1591.252f);
		...
		xrLabel120.LocationFloat = new PointFloat(52.68647f, 1591.252f);
		...
		xrLabel119.LocationFloat = new PointFloat(53.08295f, 1569.252f);
		...
		xrLabel118.LocationFloat = new PointFloat(25.70782f, 1569.252f);
		...
		xrLabel117.LocationFloat = new PointFloat(25.70782f, 1547.252f);
		...
		xrLabel116.LocationFloat = new PointFloat(52.68647f, 1547.252f);
		...
		xrLabel115.LocationFloat = new PointFloat(26.04167f, 1525.252f);
		...
		xrLabel114.LocationFloat = new PointFloat(53.08295f, 1525.252f);
		...
		xrLabel113.LocationFloat = new PointFloat(26.64555f, 1502.821f);
		...
		xrLabel112.LocationFloat = new PointFloat(0.7386208f, 1503.321f);
		...
		xrLabel111.LocationFloat = new PointFloat(26.19839f, 1480.82f);
		...
		xrLabel109.LocationFloat = new PointFloat(53.26335f, 1480.821f);
		...
		xrLabel108.LocationFloat = new PointFloat(26.1354f, 1421.547f);
		...
		xrLabel107.LocationFloat = new PointFloat(53.26012f, 1421.547f);
		...
		xrLabel106.LocationFloat = new PointFloat(26.13496f, 1380.547f);
		...
		xrLabel105.LocationFloat = new PointFloat(53.26012f, 1380.547f);
		...
		xrLabel104.LocationFloat = new PointFloat(26.13496f, 1339.547f);
		...
		xrLabel103.LocationFloat = new PointFloat(53.26012f, 1339.547f);
		...
		xrLabel102.LocationFloat = new PointFloat(26.19838f, 1298.547f);
		...
		xrLabel101.LocationFloat = new PointFloat(53.17704f, 1298.547f);
		...
		xrLabel100.LocationFloat = new PointFloat(27.13539f, 1276.615f);
		...
		xrLabel99.LocationFloat = new PointFloat(1.832347f, 1276.615f);
		...
		xrLabel98.LocationFloat = new PointFloat(53.26012f, 1254.615f);
		...
		xrLabel97.LocationFloat = new PointFloat(27.07363f, 1254.615f);
		...
		xrLabel96.LocationFloat = new PointFloat(28.13729f, 1213.547f);
		...
		xrLabel95.LocationFloat = new PointFloat(54.26031f, 1213.547f);
		...
		xrLabel94.LocationFloat = new PointFloat(54.26031f, 1172.479f);
		...
		xrLabel93.LocationFloat = new PointFloat(28.13729f, 1172.479f);
		...
		xrLabel92.LocationFloat = new PointFloat(85.32555f, 1107.712f);
		xrLabel92.Multiline = true;
		xrLabel92.Name = "xrLabel92";
		xrLabel92.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel92.SizeF = new SizeF(664.6747f, 21.58887f);
		...
		xrLabel91.LocationFloat = new PointFloat(85.32555f, 1129.301f);
		xrLabel91.Name = "xrLabel91";
		xrLabel91.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel91.SizeF = new SizeF(664.6747f, 21.58899f);
		...
		xrLabel90.LocationFloat = new PointFloat(85.32555f, 1150.89f);
		xrLabel90.Name = "xrLabel90";
		xrLabel90.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel90.SizeF = new SizeF(664.6747f, 21.58887f);
		...
		xrLabel63.LocationFloat = new PointFloat(28.13729f, 1063.809f);
		...
		xrLabel62.LocationFloat = new PointFloat(54.26031f, 1042.22f);
		...
		xrLabel57.LocationFloat = new PointFloat(28.13562f, 1042.22f);
		...
		xrLabel55.LocationFloat = new PointFloat(28.13562f, 1020.631f);
		...
		xrLabel54.LocationFloat = new PointFloat(54.26031f, 1020.631f);
		...
		xrLabel38.LocationFloat = new PointFloat(54.26031f, 998.3856f);
		...
		xrLabel35.LocationFloat = new PointFloat(28.13562f, 998.3856f);
		...
		xrLabel53.LocationFloat = new PointFloat(54.26031f, 976.7965f);
		...
		xrLabel52.LocationFloat = new PointFloat(28.13562f, 976.7965f);
		...
		xrLabel51.LocationFloat = new PointFloat(28.14034f, 955.7965f);
		...
		xrLabel50.LocationFloat = new PointFloat(1.893871f, 955.7965f);
		...
		xrLabel48.LocationFloat = new PointFloat(54.17728f, 917.2544f);
		...
		xrLabel48.Text = "Các chi phí phát sinh ngoài gói dịch vụ đã thỏa thuận trong Xác nhận này sẽ được thanh toán theo quy định của Bên A tại thời điểm thanh toán.";
		xrLabel48.TextAlignment = TextAlignment.TopJustify;
		xrLabel47.Font = new Font("Times New Roman", 12f);
		xrLabel47.LocationFloat = new PointFloat(25.04168f, 917.2545f);
		...
		xrLabel46.LocationFloat = new PointFloat(53.12322f, 854.088f);
		...
		xrLabel45.LocationFloat = new PointFloat(25.10335f, 854.088f);
		...
		xrLabel44.LocationFloat = new PointFloat(52.08332f, 831.0886f);
		...
		xrLabel43.LocationFloat = new PointFloat(25.10334f, 831.0886f);
		...
		xrLabel135.LocationFloat = new PointFloat(73.73918f, 487.9064f);
		xrLabel135.Name = "xrLabel135";
		xrLabel135.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		xrLabel135.SizeF = new SizeF(674.2505f, 97.63049f);
		...
		xrLabel134.LocationFloat = new PointFloat(73.73918f, 589.0908f);
		...
		BottomMargin.HeightF = 86.95774f;
